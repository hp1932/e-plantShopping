...
function ProductList() {
    ...
    const totalQuantity = useSelector((state) => state.cart.totalCartItems);
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <span className="cart-item-quantity-value">{totalQuantity}</span>
                </h1></a></div>
            </div>
        </div>
        {!showCart? (
                ...
                <div key={index}>
                    ...
                    <div className="product-list">
                        ...
                        <div className="product-card" key={plantIndex}>
                            ...
                            <button className={IsInCart(plant) ? "product-button.added-to-cart" : "product-button"} disabled={IsInCart(plant)} onClick={() => handleAddToCart(plant)}>
